var flagDataList = [
    ...
    { text: "学会理财，珍惜血汗钱", isChecked: false },
    { text: "每天至少花10分钟学英语", isChecked: false },
    { text: "再也不在深夜思考人生了", isChecked: false },
    ...
    { text: "去西藏自驾游", isChecked: false },
    { text: "再也不买皮肤浏览", isChecked: false },
    { text: "高考顺利", isChecked: false },
    ...
    { text: "遇到喜欢的人要主动一点", isChecked: false },
    ...
    { text: "月瘦10斤", isChecked: false },
    { text: "周末不宅在家", isChecked: false },
    { text: "走出舒适圈", isChecked: false },
    ...
    { text: "去北欧小镇与朋友围炉夜话", isChecked: false },
